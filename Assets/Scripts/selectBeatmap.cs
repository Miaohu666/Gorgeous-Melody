...
public class selectBeatmap : MonoBehaviour
{
    ...
    class myButton
    {
        ...
        public myButton(string filename_, Button mItemPrefab_, Transform mContentTransform_)
        {
            ...
            item.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(450,235);
        }
    ...
    public void selectBeatMap(string path)
    {
        ...
        mContentTransform.GetComponent<RectTransform>().sizeDelta = new Vector2(500, count * 100);//动态更改列表内容高度
    }
    void Update()
    {
    }
